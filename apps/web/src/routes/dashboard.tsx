    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Welcome to Tayduong Pharma ERP
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Total stock: {stats.counts.totalStock} units
            </p>
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats.counts.suppliers}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(stats.financials.monthlySales)}</div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {stats.orders.pendingPurchase} pending orders
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {stats.orders.pendingSales} pending orders
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <p className={`text-2xl font-bold ${stats.financials.monthlySales - stats.financials.monthlyPurchases >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {formatCurrency(stats.financials.monthlySales - stats.financials.monthlyPurchases)}
              </p>
            </div>
          </div>
        </CardContent>
